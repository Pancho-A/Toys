...
public class Raffle {
    ...
    public void addToy() {
        ...
        while (true) {
            ...
            title = scan.nextLine();
            if (title.isEmpty()) {
                System.out.println("Неверный ввод. Пробуйте заново.");
                break;
            }
            System.out.print("Введите частоту отсеивания: ");
            ...
            if (isDigit(value)) {
                ...
                if (frequency <= 0) {
                    ...
                    if (!toys.contains(toy) || toys.size() == 0) {
                        ...
                        System.out.println("Эта игрушка уже есть в призах.");
                    }
                }
            } else {
                System.out.println("Неверный ввод. Пробуйте заново.");
    ...
    public void setFrequency() {
        ...
        if (isDigit(value)) {
            ...
            if (selectedId >= 0 && selectedId < toys.size()) {
                ...
                System.out.print("Введите новую частоту отсеивания: ");
                value = scan.nextLine();
                if (isDigit(value)) {
                ...
                System.out.println("В призовом фонде нет игрушки с таким идентификатором.");
            }
        } else {
            System.out.println("Неверный ввод. Пробуйте заново.");
        }
    ...
    public void raffle() {
        if (toys.size() >= 2) {
            ...
            System.out.println("Добавить в призовой фонд как минимум две игрушки.");
        }
    }
